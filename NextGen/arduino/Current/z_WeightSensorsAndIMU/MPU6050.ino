...
//NOTE: I'm not sure how to choose the I2C pins it uses, but on the Lightwave, the defualt pin numbers are ok. These are: SCL(a5), and SDA(A4)
...
void setup_imu(void) 
{
  bool imu_connected=imu.begin();//This should return true, otherwise the IMU failed to start. I'll assume that it started correctly, because the Lightwave should have one hooked up.
  if(not imu_connected){Serial.println("IMU Failed to start");delay(1000);}
  ...
  imu.setFilterBandwidth   (MPU6050_BAND_21_HZ    );//All options: MPU6050_BAND_260_HZ  , MPU6050_BAND_184_HZ  , MPU6050_BAND_94_HZ    , MPU6050_BAND_44_HZ, MPU6050_BAND_21_HZ, MPU6050_BAND_10_HZ, MPU6050_BAND_5_HZ (I'm not sure exactly what this specifies...)
