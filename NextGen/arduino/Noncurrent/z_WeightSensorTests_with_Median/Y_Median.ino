...
struct ImuDelayLine
{
  ...
  void update()
  {
    ...
    accel_x_delayline(a.acceleration.x);
    accel_y_delayline(a.acceleration.y);
    accel_z_delayline(a.acceleration.z);

    gyro_x_delayline(g.gyro.x);
    gyro_y_delayline(g.gyro.y);
    gyro_z_delayline(g.gyro.z);
  }
